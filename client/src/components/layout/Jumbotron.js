...
function Jumbotron() {
  ...
  const authWelcome = (
    <>
      <h1 className="display-4 greeting">Hello {user && user.firstName},</h1>
      <p className="lead takeNoteDetail">
        welcome to your favorite note storage application
      </p>
    </>
  );
  ...
  const guestWelcome = (
    <>
      <h1 className="display-4 greeting">takeNote</h1>
      <p className="lead">
  ...
  return (
    <div className="jumbotron pb-3">
      ...
      <div style={{ width: "50%", margin: "auto" }} className="my-5">
        <p className="lead">
          <button className="btn btn-success btn-block shadow" onClick={openModal}>
            Compose A Note
          </button>
        </p>
      </div>
